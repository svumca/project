...
try{
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","college","hari");
 	...
 	ResultSet r=st.executeQuery("select name,sname,dateofbirth,dpt,crs,adno,mobile,email,password from  newuserreg where crs='"+crs+"'");
 	%>
 <table align="center" border="1px solid green">
<tr><th>NAME</th><th>SURNAME</th><th>DOB</th><th>DEPTNAME</th><th>COURSE</th><th>ADMNO</th><th>MOBILE</th><th>EMAIL</th><th>PASSWORD</th>
</tr>
